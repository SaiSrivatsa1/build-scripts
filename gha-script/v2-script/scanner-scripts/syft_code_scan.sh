...
wget https://github.com/anchore/syft/releases/download/$SYFT_VERSION/syft_${SYFT_VERSION#v}_linux_s390x.tar.gz
tar -xzf syft_${SYFT_VERSION#v}_linux_s390x.tar.gz
chmod +x syft
